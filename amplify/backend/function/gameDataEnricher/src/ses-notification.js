 ...
 * 
 * UPDATED v2.2.0:
 * - NEW: customSections support for adding arbitrary formatted sections to email
 * - Pass array of { title, content } objects to add custom sections
 * 
 * UPDATED v2.1.0:
 ...
 *   customSections: [{ title: 'MY SECTION', content: 'formatted content here' }]
 * });
 */
 ...
 * @param {Array} [options.customSections] - Custom sections to add [{ title, content }]
 */
